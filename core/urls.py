...
urlpatterns = [
	...
	path('sales/record/', views.record_sale_page, name='record_sale_page'),
	path('stock/add/', views.add_stock_page, name='add_stock_page'),
	path('stickers/print/', views.print_stickers_page, name='print_stickers_page'),
	...
	path('api/products/<int:product_id>/delete/', views.product_delete, name='product_delete'),
    ...
    path('api/sales/record/', views.record_sale, name='record_sale'),
